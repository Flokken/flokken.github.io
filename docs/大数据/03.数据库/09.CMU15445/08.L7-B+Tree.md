...
>https://blog.csdn.net/qq_41076531/article/details/128315421

感觉上面的很多知识点没有很细，我主要还是得面对就业，所以直接上点干货。

这里先简单介绍一下**二叉搜索树**。我们如果规定二叉树的插入顺序，让左子节点的元素永远小于右子节点。这种二叉树，可以快速的查询到某一个元素，就是二叉搜索树。

<img src="https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/image-20231218173121664.png" alt="image-20231218173121664" style="zoom: 80%;" />



> 二叉搜索树在一些情况退化成链，就需要用到avl树或者红黑树

**多插搜索树**

实际上多叉树和二叉树的区别就是： **多叉搜索树中的节点，可以存储多个元素**。这样，导致多叉搜索树有多个分支

B树（ **多路平衡查找树**）

> B树属于多叉树，并且是平衡多叉树。其实就是每个节点可以存多个元素，所以也可以有多个分叉

![在这里插入图片描述](https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/20190820113536214.png)

### **B+树**

终于引出了B+树，**B+树和B树的区别是B+树内部节点只存指针，不存数据，叶子节点存数据并且有序**

<img src="https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/image-20231218173804701.png" alt="image-20231218173804701" style="zoom:80%;" />
