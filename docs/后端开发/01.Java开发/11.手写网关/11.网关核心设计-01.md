...
>官网文档：https://dubbo.apache.org/zh/docs/advanced/generic-reference/
...
> Question: GenericReference是自己定义的还是jdk提供的?
...
1. 地址：**https://gitcode.net/KnowledgePlanet/gateway/api-gateway-test-provider**
2. 配置：zookeeper 3.4.13 —— 必须有注册中心，且你的 zookeeper 版本要与工程的 POM 中配置的 zookeeper 匹配，否则会启动失败
3. 操作：测试前先确保 api-gateway-test-provider 启动完成
