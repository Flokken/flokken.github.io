...
> JDK的解释：反射允许对封装类的字段，方法和构造函数的信息进行变成访问
...
1. idea可以自动的提示这个类有哪些方法，就是利用了反射

![image-20231009203607314](https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/image-20231009203607314.png)

2.idea里也可以提示方法缺少的形参，也叫反射

<img src="https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/image-20231009203648356.png" alt="image-20231009203648356" style="zoom:67%;" />
...
也就是两部分，**先获取这个类的字节码文件对象，然后利用这个字节码对象获取他的各种信息（解剖）**

![image-20231009203729324](https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/image-20231009203729324.png)

> 这个修饰符指的就是public，private这些，用getModidiers可以获取

对应java中的类如下

![image-20231009211537089](https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/image-20231009211537089.png)
...
> 具体来说就是调用这个这个构造方法的setAccessible(true)，这个方法会临时取消权限校验

**注意**

- getDeclared能获取所有，包含public,protect,private
...
场景，现在有一个老板想请明星撑场子，但是这需要签合同，联系明星啥的，这时候就可以找中介，给中介钱，让他给你搞定。

<img src="https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/image-20231009214604318.png" alt="image-20231009214604318" style="zoom:50%;" />	

**作用：**	**无侵入式的给方法增强功能**

<img src="https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/image-20231009215401176.png" alt="image-20231009215401176" style="zoom:67%;" />



**java如何创建一个代理对象？**

我们使用的是reflect的包里的Proxy类	

![image-20231009215548615](https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/image-20231009215548615.png)
...
代理对象其实就是调用了原来的对象的方法比并且运行（所以用了·反射）

<img src="https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/image-20231009213626986.png" alt="image-20231009213626986" style="zoom: 67%;" />
