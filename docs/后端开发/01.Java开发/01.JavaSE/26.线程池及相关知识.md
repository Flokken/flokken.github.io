...
![1571652681276](https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/1571652681276.png) 
...
![1571655104091](https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/1571655104091.png) 



创建一个线程池有很多参数要选可以用一个饭店的故事来类比

![image-20231007202119394](https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/image-20231007202119394.png)

![image-20231007202033174](https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/image-20231007202033174.png)

![image-20231007201955773](https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/image-20231007201955773.png)

### 线程池多大合适？

tips:最大并行数就是CPU并发线程的最大值，比如4核8线程，最大并行数就是8

<img src="https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/image-20231007202728595.png" alt="image-20231007202728595" style="zoom:67%;" />
...
![1571732060388](https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/1571732060388.png) 
...
![1571735388181](https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/1571735388181.png) 

由于此时还没有提交任务，因此线程池中的线程数量为0，工作队列的任务数量也为0；提交一个任务

![1571735465100](https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/1571735465100.png) 

再次查看各个值的变化

![1571735607347](https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/1571735607347.png)  
...
![1571735715977](https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/1571735715977.png) 

此时会把第二个任务存储到工作队列中，因此工作队列的值为1了。再次提交一个任务

再次查看各个值的变化

![1571735904991](https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/1571735904991.png) 

此时3个任务都以及提交完毕，断点跳过。经过20s以后，再次查看该进程中的线程。

![1571736824748](https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/1571736824748.png) 
...
![1571743818653](https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/1571743818653.png) 

## 3.3 问题分析

了解了一下JMM,那么接下来我们就来分析一下上述程序产生问题的原因。

![1571744627663](https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/1571744627663.png)  
...
![1571746088704](https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/1571746088704.png) 
...
![1571794778139](https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/1571794778139.png) 
...
![1571817059527](https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/1571817059527.png)  

2. 此时线程1想要把变量的值增加1。对线程1来说，旧的预期值 A = 10 ，要修改的新值 B = 11。

![1571817085047](https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/1571817085047.png) 

3. 在线程1要提交更新之前，另一个线程2抢先一步，把内存值V中的变量值率先更新成了11。

![1571817628904](https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/1571817628904.png) 

4. 线程1开始提交更新，首先进行A和内存值V的实际值比较（Compare），发现A不等于V的值，提交失败。

![1571818176635](https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/1571818176635.png) 

5. 线程1重新获取内存值V作为当前A的值，并重新计算想要修改的新值。此时对线程1来说，A = 11，B = 12。这个重新尝试的过程被称为<font color="red" size="4">**自旋**</font>。

![1571818465276](https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/1571818465276.png) 

6. 这一次比较幸运，没有其他线程改变V的值。线程1进行Compare，发现A和V的值是相等的。

![1571818597998](https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/1571818597998.png) 

7. 线程1进行SWAP，把内存V的值替换为B，也就是12。

![1571818747880](https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/1571818747880.png) 
...
![1571905221097](https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/1571905221097.png) 
...
![1571880094854](https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/1571880094854.png)  
...
![1571901607504](https://typora-1309665611.cos.ap-nanjing.myqcloud.com/typora/1571901607504.png) 
